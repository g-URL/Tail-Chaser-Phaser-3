...
class GameOver extends Phaser.Scene {
    ...
    create (score) {
        ...
        const title1 = this.add.text(320, 100, 'GAME', { fontFamily: 'EightbyFive', fontSize: '220px', color: 'black', fontStyle: 'bold', align: 'center' }).setOrigin(0.5);
        const title2 = this.add.text(320, 240, 'OVER', { fontFamily: 'EightbyFive', fontSize: '220px', color: 'black', fontStyle: 'bold', align: 'center' }).setOrigin(0.5);

        new Button(this, 320, 400, 340, 80, 'NEW GAME', 'Game Start');
        new Button(this, 320, 500, 340, 80, 'MAIN MENU', 'Menu');

        const scoreText = this.add.text(320, 565, 'SCORE: '+score, { fontFamily: 'EightbyFive', fontSize: '50px', color: 'black', fontStyle: 'bold', align: 'center' });
